...
const serializers = {
  ...
  types: {
    ...
    applyBtn: ({ node: { btnText, btnLink } }) => {
      const rightArrow =
        '<i class="align-middle ml-2 text-green-100 fas fa-angle-right text-md leading-md" aria-hidden="true"></i>';
      return y(
        "div",
        {
          className:
            "rounded block w-full bg-green-100 flex justify-between px-6 py-6",
        },
        y(
          "div",
          {
            className:
              "flex w-8/12 md:w-4/12 items-center justify-start md:justify-between",
          },
          y("img", {
            src: "../../images/logo/TGC_Square_Logo_White.svg",
            className: "h-12 mr-2 md:mr-2",
          }),
          y("p", {
            className: "text-white font-bold",
            innerHTML: "Apply for this role",
          })
        ),
        y("a", {
          href: "#",
          className:
            "flex items-center py-0 px-4 md:px-6 text-sm font-bold rounded font-heading bg-white",
          style: "color: #86ba90",
    ...
    callModal: ({ node: { title } }) =>
      h("a", {
        href: "#",
        "data-modal": "book-a-call",
        className:
          "bookacall-c-btn inline-block py-2 px-6 font-bold bg-blue-200 text-white rounded font-heading hover:bg-blue-100",
        innerHTML: title,
        style: "color: white;",
      }),
    newsletter: ({ node: { title } }) =>
      y(
        ...
        {
          className:
            "relative md:py-20 pt-14 pb-8 newsletter section-rounded-t z-10 not-on-print",
        },
        y(
          "div",
          { className: "inner" },
          y(
            ...
            y(
              ...
              y(
                "form",
                { action: "https://formspree.io/mvovolen", method: "POST" },
                y(
                  "div",
                  ...
                  y(
                    "input",
                    {
                      type: "email",
                      className:
                        "p-4 w-full text-md leading-sm h-14 text-black mb-4 md:mb-0",
                  ...
                  y("button", {
                    className:
                      "block py-4 px-5 bg-blue-200 whitespace-no-wrap text-white font-heading font-bold text-lg leading-md w-full md:w-auto",
                    type: "submit",
              ...
              y(
                "span",
                {
                  className: "block text-sm leading-xs text-white mt-2",
                  innerHTML:
    ...
    form: ({ node: { title, action } }) =>
      y(
        "div",
        { className: "overflow-hidden w-full md:mx-auto not-on-print" },
        y(
          "div",
          { className: "overflow-hidden w-full md:mx-auto not-on-print" },
          y("div", y("h2", { innerHTML: title })),
          y(
            "form",
            {
              method: "POST",
            ...
            y("div", {
              innerHTML: "Required",
              className:
                "required-pop-up absolute text-red-100 w-full text-xs leading-xs text-right mb-2 hidden",
            }),
            y(
              "div",
              y(
                ...
                y(
                  ...
                  y(
                    "select",
                    {
                      ...
                      maxlength: 50,
                      className:
                        "form-input-field rounded block w-full py-2 px-3 border-1 placeholder-black required",
                    },
                    y("option", { innerHTML: "Please select an option" }),
                    y("option", {
                      innerHTML: "I'm looking to hire an apprentice",
                    }),
                    y("option", { innerHTML: "I'm applying for a course" }),
                    y("option", {
                      innerHTML:
                        "I'm currently a learner on a Coders Guild Programme",
                    }),
              ...
              y(
                ...
                y(
                  ...
                  y(
                    "span",
                    { className: "form-error text-xs leading-xs text-red-100" },
                    {
                      attrs: {
                        "data-message": "Only alphabetical values are allowed",
                        "aria-hidden": "false",
                        role: "alert",
                      },
                    }
              ...
              y(
                ...
                y(
                  ...
                  y(
                    ...
                    {
                      attrs: { "data-regex": "^[+0-9]+$", "data-valid": false },
                    }
                  ),
                  y(
                    "span",
                    ...
                    {
                      attrs: {
                        "data-message": "Only numeric values are allowed",
                        "aria-hidden": "false",
                        role: "alert",
                      },
                    }
              ...
              y(
                ...
                y(
                  ...
                  y(
                    "span",
                    { className: "form-error text-xs leading-xs text-red-100" },
                    { attrs: { "aria-hidden": "false", role: "alert" } }
                  )
                )
              )
            ),
            y(
              ...
              y("button", {
                className:
                  "contact-btn rounded font-heading font-bold w-full block py-2 px-6 border border-transparent text-white bg-blue-200 hover:bg-blue-100 focus:bg-blue-100 active:bg-blue-100 transition duration-150 ease-in-out",
                id: "submit",
                type: "submit",
                disabled: "disabled",
                innerHTML: "Send Enquiry",
              })
            )
          )
        )
